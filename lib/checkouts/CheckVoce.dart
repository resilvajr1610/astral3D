...
class CheckVoce extends StatefulWidget {
  String comprar;
  CheckVoce(this.comprar);

  @override
  _CheckVoceState createState() => _CheckVoceState();
}

class _CheckVoceState extends State<CheckVoce> {
        ...
        body: jsonEncode(
            {
              "items": [
                {
                  "title": "Astral 3D",
                  "description": "Produto Você Herói",
                  "quantity": 1,
                  "currency_id": "ARS",
