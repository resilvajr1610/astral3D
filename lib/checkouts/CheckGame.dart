...
class CheckGame extends StatefulWidget {
  String comprar;
  CheckGame(this.comprar);

  @override
  _CheckGameState createState() => _CheckGameState();
}

class _CheckGameState extends State<CheckGame> {
  ...
  Future _uploadImagem(String foto)async{
    ...
    StorageReference arquivo = pastaRaiz
        .child("Game")
        .child(_idCompra +"_"+foto+"_Art.jpg");
