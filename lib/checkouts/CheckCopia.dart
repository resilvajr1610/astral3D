...
class CheckCopia extends StatefulWidget {
  String comprar;
  CheckCopia(this.comprar);

  @override
  _CheckCopiaState createState() => _CheckCopiaState();
}

class _CheckCopiaState extends State<CheckCopia> {
  File image;
  ...
  Future _uploadImagem(String foto)async{
    ...
    StorageReference arquivo = pastaRaiz
        .child("Copia")
        .child(_idCompra +"_"+foto+"_Copia.jpg");
