...
class CheckCrie extends StatefulWidget {
  String comprar;
  CheckCrie(this.comprar);

  @override
  _CheckCrieState createState() => _CheckCrieState();
}

class _CheckCrieState extends State<CheckCrie> {
