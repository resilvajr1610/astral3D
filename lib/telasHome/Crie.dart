...
class Crie extends StatefulWidget {
  const Crie({Key key}) : super(key: key);

  @override
  _CrieState createState() => _CrieState();
}

class _CrieState extends State<Crie> {
  ...
  var _listWhats = [
    {'id':0, 'image':'assets/imagens/crie3.png'},
    {'id':1, 'image':'assets/imagens/crie4.png'}
  ];
  ...
  _produtoSelecionado(){
    ...
    if(_itemSelecionadoCor== "pintado" || _itemSelecionadoCor== "preto"|| _itemSelecionadoCor== "branco"){
      ...
      Navigator.pushNamed(context,"/crie",arguments: _idCompra.idCompra);
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('( 154 )',style: TextStyle(color: Colors.white,
              ...
              Container(
                  ...
                  child: Text("Apenas as últimas 3 produções nesse valor".toUpperCase(),style: TextStyle(color: Colors.white,
                      fontFamily: 'Montserrat',
                      fontSize: 10,
                      fontWeight: FontWeight.bold))
              ),
              ...
              Container(
                  ...
                  child: Text('Você gostaria que os seus desenhos, viessem para o mundo real?',
                    textAlign: TextAlign.center,
              ...
              Flexible(
                child: Container(
                  ...
                  child: Text('Enviando o seu desenho para nós, modelaremos em 3D e a máquina 3D irá dar vida ao seu desenho.',
                    textAlign: TextAlign.center,
