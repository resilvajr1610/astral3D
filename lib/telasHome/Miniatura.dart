...
class Miniatura extends StatefulWidget {
  const Miniatura({Key key}) : super(key: key);

  @override
  _MiniaturaState createState() => _MiniaturaState();
}

class _MiniaturaState extends State<Miniatura> {
  ...
  var _listWhats = [
    {'id':0, 'image':'assets/imagens/miniatura3.png'},
    {'id':1, 'image':'assets/imagens/miniatura4.png'}
  ];
  ...
  _produtoSelecionado(){
    ...
    if(_itemSelecionadoCor== "pintado" || _itemSelecionadoCor== "preto"|| _itemSelecionadoCor== "branco"){
      ...
      Navigator.pushNamed(context,"/mini",arguments: _idCompra.idCompra);
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('( 112 )',style: TextStyle(color: Colors.white,
                ...
                Container(
                    ...
                    child: Text("Apenas as últimas 4 produções nesse valor".toUpperCase(),style: TextStyle(color: Colors.white,
                        fontFamily: 'Montserrat',
                        fontSize: 10,
                        fontWeight: FontWeight.bold))
                ),
                ...
                Container(
                    ...
                    child: Text('O objeto mais bonito de decoração?',
                      textAlign: TextAlign.center,
                ...
                Flexible(
                  child: Container(
                    ...
                    child: Text('Mande fotos nas posiçôes que indicaremos após clicar em "adquirir" e você, alguém que conhece ou seu Pet, irão virar uma linda Miniatura.',
                      textAlign: TextAlign.center,
                ...
                Container(
                  ...
                  child: Text('clique em adquirir e FAÇA PARTE do futuro'.toUpperCase(),textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.white,
                        fontSize: 12,fontWeight: FontWeight.bold,fontFamily: 'Mokoto'),
                  ),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton(
                            ...
                            onChanged: (categoria){
                              setState(() {
                                _itemSelecionadoCor = categoria;
                                print("item : "+_itemSelecionadoCor);
                                _corSelecionada();
                              });
                            },
                          ),
