import 'dart:async';
import 'package:astrall/Slides/SlideAction.dart';
import 'package:astrall/Slides/SlideDuvidas.dart';
...
class ArtAction extends StatefulWidget {

  @override
  _ArtActionState createState() => _ArtActionState();
}

class _ArtActionState extends State<ArtAction> {
  ...
  var _listSlide = [
    {'id':0, 'image':'assets/imagens/art2.png'},
    {'id':1, 'image':'assets/imagens/art3.png'},
    {'id':2, 'image':'assets/imagens/art4.png'},
    {'id':3, 'image':'assets/imagens/art5.png'},
    {'id':4, 'image':'assets/imagens/art6.png'},
  ];

  var _listWhats = [
    {'id':0, 'image':'assets/imagens/art7.png'},
    {'id':1, 'image':'assets/imagens/art8.png'}
  ];
  ...
  _produtoSelecionado(){
    ...
    if(_itemSelecionadoCor== "pintado" || _itemSelecionadoCor== "preto"|| _itemSelecionadoCor== "branco"){
      ...
      Navigator.pushNamed(context,"/art",arguments: _idCompra.idCompra);
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('( 103 )',style: TextStyle(color: Colors.white,
              ...
              Container(
                  ...
                  child: Text('Recrie seu ator, personagem ou músico favorito',
                    textAlign: TextAlign.center,
