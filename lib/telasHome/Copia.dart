...
class Copia extends StatefulWidget {
  const Copia({Key key}) : super(key: key);

  @override
  _CopiaState createState() => _CopiaState();
}

class _CopiaState extends State<Copia> {
  ...
  var _listWhats = [
    {'id':0, 'image':'assets/imagens/copia4.png'},
    {'id':1, 'image':'assets/imagens/copia5.png'}
  ];
  ...
  _produtoSelecionado(){
    ...
    if(_itemSelecionadoCor== "pintado" || _itemSelecionadoCor== "preto"|| _itemSelecionadoCor== "branco"){
      ...
      Navigator.pushNamed(context,"/copia",arguments: _idCompra.idCompra);
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text('( 71 )',style: TextStyle(color: Colors.white,
              ...
              Container(
                  ...
                  child: Text('Você gostaria de recriar qualquer coisa que quisesse? ',
                    textAlign: TextAlign.center,
              ...
              Flexible(
                child: Container(
                  ...
                  child: Text('Imagine se qualquer coisa que você visse, pudesse ser criado uma réplica. Seria um super poder e tanto, não é mesmo?',
                    textAlign: TextAlign.center,
              ...
              Container(
                  ...
                  child: Text('AGORA É POSSIVEL '.toUpperCase(),
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.white,
                      fontSize: 20,
                      fontFamily: 'Mokoto',
