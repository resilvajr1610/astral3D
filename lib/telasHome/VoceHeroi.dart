...
class VoceHeroi extends StatefulWidget {
  const VoceHeroi({Key key}) : super(key: key);

  @override
  _VoceHeroiState createState() => _VoceHeroiState();
}

class _VoceHeroiState extends State<VoceHeroi> {
  ...
  var _listWhats = [
    {'id':0, 'image':'assets/imagens/voce3.png'},
    {'id':1, 'image':'assets/imagens/voce4.png'}
  ];
  ...
  _produtoSelecionado(){
    ...
    if(_itemSelecionadoCor== "pintado" || _itemSelecionadoCor== "preto"|| _itemSelecionadoCor== "branco"){
      ...
      Navigator.pushNamed(context,"/voce",arguments: _idCompra.idCompra);
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: Text('( 144 )',style: TextStyle(color: Colors.white,
                ...
                Container(
                    ...
                    child: Text('Já pensou como seria fantástico, o seu rosto no seu personagem favorito?',
                      textAlign: TextAlign.center,
                ...
                Flexible(
                  child: Container(
                    ...
                    child: Text('Após clicar em "ADQUIRIR". mande uma foto do seu rosto + a foto do personagem que deseja, e daremos vida a ela na máquina 3D em um linda Miniatura.',
                      textAlign: TextAlign.center,
